...
for i in range(len(parni_elf_raspon)):
    if parni_elf_raspon[i][0] in neparni_elf_raspon[i] and parni_elf_raspon[i][-1] in neparni_elf_raspon[i]:
        brojac += 1
    elif neparni_elf_raspon[i][0] in parni_elf_raspon[i] and neparni_elf_raspon[i][-1] in parni_elf_raspon[i]:
        brojac += 1
